...
import catChill from "../../images/catHeadphones.png";
import headMusic from "../../images/head-white.png";
  ...
  return (
    <main className="home-page">
      ...
      <div className="first">
        ...
        <img
          alt="cat sitting on a couch chilling with headphones on"
          src={catChill}
        />
      </div>
      <p className="description" ref={descriptionText}>
        ...
        is an interactive web app that brings your audio to life with stunning
        visuals. Upload your own audio files or browse our collection, and
        experience a whole new way of visualizing sound.
      </p>
      <div className="second">
        ...
        <p>
          ...
          reveal the hidden emotions in your favorite music
        </p>
      </div>
      <p className="data-analysis-des" ref={dataAnalysisDesRef}>
        ...
        uses audio data analysis to create stunning visualizations that bring
        your audio to life.
      </p>
      <img
        loading="lazy"
        ...
        src={audioVid}
        className="visual-vid"
      />
      {/* <video className="visual-vid" src={audioVid} autoPlay={true} /> */}
      <button className="last" onClick={handleClick}>
        Let's Go!
      </button>
      <br />
